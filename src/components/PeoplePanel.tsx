      ...
      <header className="flex items-center gap-3 border-b border-zinc-200 bg-white px-4 py-3 dark:border-zinc-800 dark:bg-zinc-900">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="text-xs text-zinc-500">
            Search by username, send follow requests, chat privately
          </p>
        </div>
      </header>
      ...
      <div className="border-b border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-900">
        <label className="flex flex-col gap-1 text-xs font-medium text-zinc-500">
          ...
          <input
            ...
            autoFocus
            className="rounded-lg border border-zinc-300 px-3 py-2 text-sm text-zinc-900 outline-none transition-colors focus:border-indigo-500 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-50 dark:focus:border-indigo-400"
          />
        </label>
      </div>
      ...
      <div className="flex-1 divide-y divide-zinc-200 overflow-y-auto dark:divide-zinc-800">
        {query.trim().length >= 2 && (
          <section>
            ...
            {searching && (
              <p className="px-4 py-4 text-sm text-zinc-400">Searching…</p>
            )}
