...
export function Landing({
  ...
  return (
    <main className="flex flex-1 items-center justify-center p-6">
      <form
        onSubmit={submit}
        className="flex w-full max-w-md flex-col gap-5 rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm dark:border-zinc-800 dark:bg-zinc-900"
      >
        ...
        <div className="flex items-center gap-3">
          {avatar ? (
            ...
            <div className="flex h-12 w-12 items-center justify-center rounded-full bg-zinc-200 text-zinc-500 dark:bg-zinc-700">
              +
            </div>
          )}
          <button
        ...
        {mode === "join" && (
          <label className="flex flex-col gap-1.5">
            ...
            <input
              ...
              maxLength={6}
              required
              className="rounded-lg border border-zinc-300 px-4 py-2 text-center text-2xl tracking-[0.5em] outline-none focus:border-zinc-500 dark:border-zinc-700"
            />
          </label>
        )}
