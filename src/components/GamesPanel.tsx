    ...
    <main className="flex min-h-0 flex-1 flex-col overflow-hidden bg-zinc-100 dark:bg-zinc-950">
      <header className="flex items-center gap-3 border-b border-zinc-200 bg-white px-4 py-3 dark:border-zinc-800 dark:bg-zinc-900">
        ...
        <div className="min-w-0 flex-1">
          <h1 className="text-base font-bold sm:text-lg">Games</h1>
        ...
        <button
          ...
          className="rounded-full bg-gradient-to-r from-indigo-600 via-pink-500 to-amber-500 px-3.5 py-1.5 text-xs font-semibold text-white shadow sm:px-4 sm:py-2 sm:text-sm"
        >
          {showNew ? "Close" : "New Game"}
        </button>
      </header>
      ...
      {showNew && (
        <div className="border-b border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-900 space-y-4">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 pt-1 border-t border-zinc-100 dark:border-zinc-800">
            <button
              ...
              disabled={busy}
              className="rounded-lg bg-indigo-600 px-4 py-2 text-xs sm:text-sm font-semibold text-white transition-opacity hover:opacity-90 disabled:opacity-40"
            >
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                inputMode="numeric"
                maxLength={6}
                className="w-28 rounded-lg border border-zinc-300 px-3 py-1.5 text-center text-sm font-mono tracking-widest text-zinc-900 outline-none dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-50"
              />
              <button
                type="button"
                onClick={() => void joinGame()}
                disabled={busy || joinCode.length !== 6}
                className="rounded-lg bg-emerald-600 px-3.5 py-1.5 text-xs sm:text-sm font-semibold text-white transition-opacity hover:opacity-90 disabled:opacity-40"
              >
                Join
              </button>
            </div>
