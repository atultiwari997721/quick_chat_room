...
export default function Home() {
  ...
  return (
    <div className="flex h-dvh w-full overflow-hidden bg-zinc-100 dark:bg-zinc-950">
      ...
      {/* FAB and Mobile Nav (Hidden when in an active chat) */}
      {!active && (
        <>
          <button
            type="button"
          ...
          <nav className="fixed bottom-0 left-0 right-0 z-30 flex items-center justify-around border-t border-zinc-200 bg-white/95 px-2 py-2 backdrop-blur-md dark:border-zinc-800 dark:bg-zinc-900/95 md:hidden pb-safe">
            <button
              type="button"
